...
abstract class DefaultAnalyticsListener : AnalyticsListener {
    ...
    open fun onPlayerError(eventTime: AnalyticsListener.EventTime, error: ExoPlaybackException) {}
    ...
    open fun onAudioSessionId(eventTime: AnalyticsListener.EventTime, audioSessionId: Int) {}
    ...
    open fun onRenderedFirstFrame(eventTime: AnalyticsListener.EventTime,
                                  surface: Surface?) {}
