...
import com.fivecentscdnanalytics.interfaces.ObservableSupport
...
import com.fivecentscdnanalytics.features.httprequesttracking.OnDownloadFinishedEventListener
...
class ExoPlayerHttpRequestTrackingAdapter(private val player: SimpleExoPlayer, private val onAnalyticsReleasingObservable: Observable<OnAnalyticsReleasingEventListener>) : Observable<OnDownloadFinishedEventListener>,
    OnAnalyticsReleasingEventListener {
    ...
    private fun notifyObservable(eventTime: AnalyticsListener.EventTime, loadEventInfo: LoadEventInfo, mediaLoadData: MediaLoadData, success: Boolean, statusCode: Int) {
        ...
        observableSupport.notify { listener -> listener.onDownloadFinished(
            OnDownloadFinishedEventObject(httpRequest)
        ) }
    }
